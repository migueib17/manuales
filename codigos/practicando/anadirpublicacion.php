    ...
    <body>
        ...
        <h1>Crear publicación:</h1>
            ...
            if (!empty($_POST['titulo'])  && !empty($_POST['autores'])){
                    ...
                    $sql = "SELECT COUNT(titulo) as existe FROM publicaciones WHERE titulo =\"" . $_POST['titulo'] . "\" ;";
                    ...
                    if ($result->num_rows > 0) {  
                        ...
                        //Si no hay ya un publicacion con el mismo insertamos datos
                               ...
                               VALUES ( \"" . $_POST['id_proyec'] . "\" , \"" . $_POST['tipo'] . "\" , \"" . $_POST['doi'] . "\" , \"" . $_POST['titulo'] . "\" ,
                            ...
                            if ($conn->query($sql) === FALSE) {                 //Si se produce fallo al crear el publicacion que lo vuelva a intentar
                                ...
                                echo "Error: Al insertar una publicación se debe corresponder con un proyecto, está vinculada con un ID proyecto <a href=\"anadirpublicacion.php\">vuelva a intentarlo<br>";
                                $conn->close();
                                exit();
