             ...
             *              */
                ...
                */                
                ...
                if(!isset($codprofesor) && !isset($codborrar) && !isset($_POST['nombre'])  && !isset($_POST['usuario'])){ 
                    ...
                    $sql = "SELECT dni, nombre, username FROM usuarios WHERE ((type= \"profesor\") AND (dni=\"" . $codadmin . "\")) ;";
                ...
                if(isset($codprofesor)){ 
                    ...
                    $sql = "SELECT dni, email, nombre, password, username FROM usuarios WHERE dni=\"" . $codprofesor . "\" ;";
                    $result = $conn->query($sql);
                ...
                if ($conn->query($sql) === FALSE) {
                    ...
                    //INFORMACION DEL EVENTO PARA EL LOG
                                            ...
                                            $accion="Borrado el miembro correctamente";
