...
<script>
                    ...
                    if (($result->num_rows > 0)) {  
                        ...
                        //Si no hay ya un publicacion con el mismo insertamos datos
                            ...
                            $sql="INSERT INTO publicaciones (id_proyec, tipo, doi, titulo, autores, fechaPublicacion, resumen, palabras, url, id_proyecto) 
                               VALUES ( \"" . $_POST['id_proyec'] . "\" , 'libro' , \"" . $_POST['doi'] . "\" , \"" . $_POST['titulo'] . "\" ,
    ...
    <?php
                                            ...
                                            $sql2="INSERT INTO libros (id_publicaciones, editorial, editor, isbn) 
                                            VALUES ( \"" . $_SESSION['$idpubli'] . "\" , \"" . $_POST['editorial'] . "\" , \"" . $_POST['editor'] . "\" , \"" . $_POST['isbn'] . "\")" ;
                                            ...
                                            generaLogs($username,$accion,$origen);
                                                ...
                                                echo "Error: en la creación de la publicación libro por favor <a href=\"anadirpublicacion.php\">vuelva a intentarlo<br>";
                                                 $conn->close();
                                                exit();
            ...
            ?>" onsubmit=" return comprobacionDatos(&quot;fcrear&quot;)" method="POST">
                ...
                <tr>
                    ...
                    <td> <select id="tipopubli" name="tipopubli" onchange="location = this.value;">
                             ...
                             <option value="anadirlibro.php" selected="selected">Libro</option>
                ...
                <tr>
                    ...
                    <td>ISBN:</td>
                    <td><p><input type="text" name="isbn"/></p></p><p id="isbn"></p></td>
                </tr>
                <tr>
                    <td>Título:</td>
