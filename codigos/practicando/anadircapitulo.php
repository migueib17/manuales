...
<script>
                    ...
                    if (($result->num_rows > 0)) {  
                        ...
                        //Si no hay ya un publicacion con el mismo insertamos datos
                            ...
                            $sql="INSERT INTO publicaciones (id_proyec, tipo, doi, titulo, autores, fechaPublicacion, resumen, palabras, url, id_proyecto) 
                               VALUES ( \"" . $_POST['id_proyec'] . "\" , 'capitulo' , \"" . $_POST['doi'] . "\" , \"" . $_POST['titulo'] . "\" ,
    ...
    <?php
                                            ...
                                            $sql2="INSERT INTO capitulos (id_publicaciones, titulo, editorial, editor) 
                                            VALUES ( \"" . $_SESSION['$idpubli'] . "\" , \"" . $_POST['titulo'] . "\" , \"" . $_POST['editorial'] . "\" , \"" . $_POST['editor'] . "\")" ;
                                            ...
                                            generaLogs($username,$accion,$origen);
                                                ...
                                                echo "Error: en la creación de la publicación CAPÍTULO por favor <a href=\"anadirpublicacion.php\">vuelva a intentarlo<br>";
                                                 $conn->close();
                                                exit();
                                            ...
                                            $accion="Exito al crear la publicacion";
            ...
            ?>" onsubmit=" return comprobacionDatos(&quot;fcrear&quot;)" method="POST">
                ...
                <tr>
                    ...
                    <td> <select id="tipopubli" name="tipopubli" onchange="location = this.value;">
                             ...
                             <option value="anadircapitulo.php" selected="selected">Capítulo</option>
                             <option value="anadirconferencia.php">Conferencia</option>
                        </select>
                ...
                <tr>
                    ...
                    <td>Editorial:</td>
                    <td><p><input type="text" name="editorial"/></p></p><p id="editorial"></p></td>
                </tr>
                <tr>
                    <td>DOI:</td>
                    <td><p><input type="text" name="doi"/></p></p><p id="doi"></p></td>
                    <td>Editor:</td>
                    <td><p><input type="text" name="editor"/></p></p><p id="editor"></p></td>
                </tr>
                <tr>
                    <td>Título:</td>
                    <td><p><input type="text" name="titulo"/></p><p id="titulo"></p></td>
                    <td>ISBN:</td>
                    <td><p><input type="text" name="nomrevista"/></p></p><p id="nomrevista"></p></td>
                </tr>
                <tr>
                    <td>Autores:</td>
                    <td><p><input type="text"  name="autores"></p><p id="autores"></p></td>
                    <td>Páginas del Capítulo:</td>
                    <td><p><input type="text" name="nomrevista"/></p></p><p id="nomrevista"></p></td>
                </tr>
                <tr>
                    <td>Fecha de Publicación:</td>
