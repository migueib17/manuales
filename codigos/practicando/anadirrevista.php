...
<script>
                    ...
                    if (($result->num_rows > 0)) {  
                        ...
                        //Si no hay ya un publicacion con el mismo insertamos datos
                            ...
                            $sql="INSERT INTO publicaciones (id_proyec, tipo, doi, titulo, autores, fechaPublicacion, resumen, palabras, url, id_proyecto) 
                               VALUES ( \"" . $_POST['id_proyec'] . "\" , 'revista' , \"" . $_POST['doi'] . "\" , \"" . $_POST['titulo'] . "\" ,
    ...
    <?php
                                            ...
                                            $sql2="INSERT INTO revistas (id_publicaciones, nombre, volumen, paginas) 
                                            VALUES ( \"" . $_SESSION['$idpubli'] . "\" , \"" . $_POST['nombre'] . "\" , \"" . $_POST['volumen'] . "\" , \"" . $_POST['paginas'] . "\")" ;
                                            ...
                                            generaLogs($username,$accion,$origen);
                                                ...
                                                echo "Error: en la creación de la publicación REVISTA por favor <a href=\"anadirpublicacion.php\">vuelva a intentarlo<br>";
                                                 $conn->close();
                                                exit();
            ...
            ?>" onsubmit=" return comprobacionDatos(&quot;fcrear&quot;)" method="POST">
                ...
                <tr>
                    ...
                    <td> <select id="tipopubli" name="tipopubli" onchange="location = this.value;">
                             ...
                             <option name="nomrevista" value="anadirrevista.php" selected="selected">Artículo de Revista</option>
                ...
                <tr>
                    ...
                    <td>Volumen:</td>
                    <td><p><input type="text" name="volumen"/></p></p><p id="volumen"></p></td>
                </tr>
                <tr>
                    <td>DOI:</td>
                    ...
                    <td>Páginas:</td>
                    <td><p><input type="text" name="paginas"/></p></p><p id="paginas"></p></td>
                </tr>
                <tr>
                    <td>Título:</td>
